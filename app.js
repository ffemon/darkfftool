const RAW = "https://raw.githubusercontent.com/ffemon/darkfftool/main/subscription.json";
...
async function uploadToGitHub(json) {
  let token = "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";
  
  await fetch(`https://api.github.com/repos/ffemon/darkfftool/contents/${FILE}`, {
    method: "PUT",
    headers: {
...
async function getSHA() {
  let r = await fetch(`https://api.github.com/repos/ffemon/darkfftool/contents/${FILE}`);
  let d = await r.json();
  return d.sha;
}

//github token ;:-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